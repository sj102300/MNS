...
bool TCC::UdpReceiver::init(EngagementManager * engagementManager) {
	...
	//recvAddr_.sin_addr.s_addr = inet_addr("192.168.2.189");			//승엽
	recvAddr_.sin_addr.s_addr = inet_addr("192.168.2.188");			//명준
	//recvAddr_.sin_addr.s_addr = inet_addr("192.168.2.180");			//승주
